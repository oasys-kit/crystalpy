...
class DiffractionSetupShadowPreprocessor(DiffractionSetupAbstract):
    ...
    def __init__(self,
        ...
        self._shadow4_bragg = Bragg.create_from_preprocessor_file(preprocessor_file)
    ...
    def angleBragg(self, energy):
        ...
        :return: Bragg angle.
        """
        return self._shadow4_bragg.bragg_angle(energy)
    ...
    def dSpacing(self):
        ...
        """
        return 1e10 * self._shadow4_bragg.d_spacing()
    ...
    def unitcellVolume(self):
        ...
        """
        return 1e30 * self._shadow4_bragg.unit_cell_volume()
    ...
    def Fall(self, energy, rel_angle=1.0):
        ratio = self._shadow4_bragg.ratio(energy, theta=(self.angleBragg(energy) * rel_angle))

        F_0, FH, FH_BAR, STRUCT, FA, FB = self._shadow4_bragg.structure_factor(energy, ratio)
...
if __name__ == "__main__":
    ...
    a = DiffractionSetupShadowPreprocessor(geometry_type=BraggDiffraction,
                 crystal_name="Si", thickness=1e-5,
                 miller_h=1, miller_k=1, miller_l=1,
                 asymmetry_angle=0.0,
                 azimuthal_angle=0.0,
                 preprocessor_file="../examples/bragg.dat")
